...
fn run(
    ...
    let cfg = EncoderConfig::new(w, h, fps_val)
        ...
        .with_inter_dead_zone(inter_dead_zone);
    ...
    for pre_frame in predecoded_frames.into_iter() {
        ...
        fm.residual_bytes = Some(st.residual_bytes);
