...
pub struct EncoderConfig {
    ...
    pub intra_quality: u8, // 1-100 JPEG quality for I-frames
    pub inter_quality: u8, // 1-100 JPEG quality for residual maps (P-frames)
    ...
    /// RDO Lambda multiplier. Default: 0.45
